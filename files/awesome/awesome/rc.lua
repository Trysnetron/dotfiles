...
local mybatteryupdate = function() 
    ...
    local bat0 = file:read() 
    file:close()
    file = io.open("/sys/class/power_supply/BAT1/capacity", "r")
    local bat1 = file:read()
    file:close()
    mybattery.text = "BAT:"..(bat0+bat1)/2
end
mybatteryupdate()
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "web", "code","terminal", "div", "music" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioMicMute",
        function() awful.spawn("pactl set-source-mute 1 toggle") end,
        { description = "toggle mic", group = "audio" }),
    
    -- Monitor
    awful.key({}, "XF86MonBrightnessUp", 
        function() awful.spawn("light -A 10") end,
        { description = "increase backlight", group = "monitor" }),
    
    awful.key({}, "XF86MonBrightnessDown", 
        function() awful.spawn("light -U 10") end,
        { description = "decrease backlight", group = "monitor" })
...
awful.rules.rules = {
    ...
    -- Force terminals to size correctly
    {
